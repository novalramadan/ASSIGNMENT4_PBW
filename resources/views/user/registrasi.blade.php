<x-guest-layout>
    <form method="POST" action="{{ route('user.storePengguna') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <!-- Tombol Reset -->
            <button type="reset" class="ml-4 p-2 rounded-md text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                {{ __('Reset') }}
            </button>
        </div>
    </form>
